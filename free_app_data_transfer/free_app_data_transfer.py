...
1. Create Custom Field tabs for Contact and ContactAction
  a. This is crucial.  This app won't run if this step is skipped.
2. Add the source appname and apikey, and destination appname and apikey below
3. If we are transferring only contacts with a certain ID, include that in the
   CONTACTS_WITH_TAG_IDS variable, comma separated
